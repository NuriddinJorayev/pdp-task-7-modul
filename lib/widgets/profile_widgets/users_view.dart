...
class UserView {
  ...
  static Widget User_post_follow_following(String img_url, String name, String subtitle, String post, String follow, String following) => Container(
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Text(subtitle, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w400),),
          ],
        )
      ],
    ),
 ...
 static Widget _text_builder(String text1, String text2)=> Column(
    ...
    children: [
      Text(text1, style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900),),
      SizedBox(height: 5),
          ...
          Expanded(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: Text("Edit profile", style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, letterSpacing: .8),),
              ),
            ),
          ),SizedBox(width: 10.0),
          GestureDetector(
            ...
            child: Container(
              ...
              child: Icon(isSelect ? FlutterIcons.person_add_mdi : Feather.user_plus, color: Colors.black, size: 18,),
            ),
          ),
      ],
    ),
